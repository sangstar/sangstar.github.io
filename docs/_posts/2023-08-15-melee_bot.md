...
The POC is there, ultimately. With far more elaborate, current data, a higher bit quantization, and allowing for more time to train by increasing batch size, and fiddling with LoRa parameters a bit, it could probably be far more respectable.