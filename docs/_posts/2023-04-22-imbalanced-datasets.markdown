...
Accuracy as a metric is rife throughout machine learning libraries like Tensorflow, where validation accuracy is a common early stopping criterion for training. However, I personally hate accuracy as a metric and I don't really see any good use for it. 